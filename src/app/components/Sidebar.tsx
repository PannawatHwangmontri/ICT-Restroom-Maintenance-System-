...
export default function Sidebar({ isMobileOpen = false, setIsMobileOpen }: SidebarProps) {
  ...
  // 3. เพิ่มฟังก์ชันกดออกจากระบบ
  const handleLogout = () => {
    // สามารถเคลียร์ Session / Token / LocalStorage เพิ่มเติมตรงนี้ได้
    // localStorage.removeItem('token');

    // พาย้อนกลับไปหน้าเข้าสู่ระบบ (ปรับพาธตามพาธหน้า Login จริงของคุณ เช่น '/' หรือ '/Admin/login')
